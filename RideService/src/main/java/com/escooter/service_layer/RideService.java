...
public interface RideService {
    ...
    Ride startNewRide(String userId, String eScooterId) throws RideNotPossibleException;
    void stopRide(String id) throws RideNotFoundException, RideAlreadyEndedException;
